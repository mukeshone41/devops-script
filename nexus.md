...
wget https://download.sonatype.com/nexus/3/nexus-3.75.0-06-unix.tar.gz

##Extract the Nexus repository setup in /opt directory
tar -zxvf nexus-3.75.0-06-unix.tar.gz

##Rename the extracted Nexus setup folder to nexus
sudo mv /opt/nexus-3.75.0-06/ /opt/nexus
...
sudo visudo -f /etc/sudoers.d/nexus
